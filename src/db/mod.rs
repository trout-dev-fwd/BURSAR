...
use crate::db::tax_ref_repo::TaxRefRepo;
...
impl EntityDb {
    ...
    /// Returns a TaxRefRepo borrowing this connection.
    pub fn tax_refs(&self) -> TaxRefRepo<'_> {
        TaxRefRepo::new(&self.conn)
    }
